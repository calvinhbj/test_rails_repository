...
class CombosControllerTest < ActionController::TestCase
  ...
  test "should create combo" do
    assert_difference('Combo.count') do
      post :create, combo: { code: @combo.code, description: @combo.description, money: @combo.money, name: @combo.name }
    end
  ...
  test "should update combo" do
    patch :update, id: @combo, combo: { code: @combo.code, description: @combo.description, money: @combo.money, name: @combo.name }
    assert_redirected_to combo_path(assigns(:combo))
  end
